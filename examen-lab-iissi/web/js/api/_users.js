...
const usersAPI_auto = {
    ...
    getById: async function(idUser) {
        let response = await axios.get(`${BASE_URL}/users/${idUser}`, requestOptions);
    ...
    update: async function(formData, idUser) {
        let response = await axios.put(`${BASE_URL}/users/${idUser}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'users' by its primary key */
    delete: async function(idUser) {
        let response = await axios.delete(`${BASE_URL}/users/${idUser}`, requestOptions);
        return response.data;
    },
};
